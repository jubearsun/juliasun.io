      ...
      <div>
        ...
        <div className="page page--bettas">
          <div className="hero--img">
            <img src="../img/about/bettas/fts.jpeg" alt="fts" />
          </div>
          ...
          <div className="card__wrapper">
            <div className="img__wrapper">
              <img src="../img/about/bettas/3gal.JPG" alt="3 gallon tank" />
            </div>
          ...
          <div className="belt__wrapper">
            <div className="img__wrapper">
              <img src="../img/about/bettas/ictransformation.jpg" alt="ice cube" />
            </div>
            <div className="img__wrapper">
              <img src="../img/about/bettas/dratinibefore.jpg" alt="dratini before" />
            </div>
            <div className="img__wrapper">
              <img src="../img/about/bettas/dratiniafter.JPG" alt="dratini after" />
            </div>
          </div>
          <div className="textbox">
            <div className="textbox--title">
